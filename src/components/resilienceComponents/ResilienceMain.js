...
import {fetchResilience} from '../../redux/actions/postActions'
...
export default function ResilienceMain(props) {
    ...
    let resilienceHighlight
    let resilienceMainArticle


    if(state.resilience) {
        // HIGHLIGHT ARTICLE
        resilienceHighlight = state.resilience.slice(0, 1).map(item => {
            return(
                <Col lg={11}>
        ...
        // MAIN ARTICLE
        resilienceMainArticle = state.resilience.slice(1, 3).map(item => {
            return(
            ...
            <Container style={{}} >
                <Row>
                    <Col lg={6}>       
                        <div style={{marginTop: '10px'}}>         
                            <h2>RESILIENCE, INNOVATION + CYBER SECURITY</h2>
                        </div>
                    </Col>
                    <Col lg={6}>
                        <Breadcrumb className='breadcrumb'>
                            <Breadcrumb.Item href="http://localhost:3000">Home</Breadcrumb.Item>
                            <Breadcrumb.Item active>Resilience, Innovation + Cyber Security</Breadcrumb.Item>
                        </Breadcrumb>
                    </Col>
                </Row>
                ...
                <Row>
                    <Col style={{marginLeft: '50%'}}>
                        <a href='viewAll/5'>View All Articles  <BsChevronDown /></a>
                    </Col>
                </Row>
