...
import {fetchCapital} from '../../redux/actions/postActions'
...
export default function CapitalMain(props) {
    ...
    let capitalHighlight
    let capitalMainArticle


    if(state.capital) {
        // HIGHLIGHT ARTICLE
        capitalHighlight = state.capital.slice(0, 1).map(item => {
            return(
                <Col lg={11}>
        ...
        // MAIN ARTICLE
        capitalMainArticle = state.capital.slice(1, 3).map(item => {
            return(
            ...
            <Container style={{}} >
                <Row>
                    ...
                    <Col lg={6}>
                        <Breadcrumb className='breadcrumb'>
                            ...
                            <Breadcrumb.Item active>Capital Markets</Breadcrumb.Item>
                        </Breadcrumb>
                    </Col>
                </Row>
                ...
                <Row>
                    <Col style={{marginLeft: '50%'}}>
                        <a href='viewAll/4'>View All Articles  <BsChevronDown /></a>
                    </Col>
                </Row>
