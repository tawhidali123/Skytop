...
import {fetchCsr} from '../../redux/actions/postActions'
...
export default function CsrMain(props) {
    ...
    if(state.csr) {
        // HIGHLIGHT ARTICLE
        csrHighlight = state.csr.slice(0, 1).map(item => {
            return(
                <Col lg={11}>
        ...
        // MAIN ARTICLE
        csrMainArticle = state.csr.slice(1, 3).map(item => {
            return(
            ...
            <Container style={{}} >
                <Row>
                    ...
                    <Col lg={6}>
                        <Breadcrumb className='breadcrumb'>
                            ...
                            <Breadcrumb.Item active>CSR & Sustainability</Breadcrumb.Item>
                        </Breadcrumb>
                    </Col>
                </Row>
                ...
                <Row>
                    <Col style={{marginLeft: '50%'}}>
                        <a href='viewAll/2'>View All Articles  <BsChevronDown /></a>
                    </Col>
                </Row>
